# Brief Introduction to OAuth (Documentation Sample)

## Purpose

This repository is a documentation sample that provides a high-level overview of how OAuth is used within a system to support secure delegated access to protected resources.
...
- Technical writers
- Technical support and operations engineers
- Software developers
...
Start with the main document: [Brief Introduction to OAuth](docs/oauth-brief-intro.md)
